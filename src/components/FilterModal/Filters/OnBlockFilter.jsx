...
class OnBlockFilter extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.defaultValues = [
            ...
            {
                label: 'Minus on block (safe)',
                min: -9,
                max: 0
            },
            {
                label: 'Minus on block (unsafe)',
        ...
        const selectedValue = this.defaultValues.find(value => 
            value.min === this.props.min && value.max === this.props.max);

        this.state = {
            showCustomFilters: selectedValue ? false : true
        }
    ...
    render() {
        ...
        return (
            <Form.Group>
                <Form.Label className="mr-2">On Block</Form.Label>
                <Dropdown>
