...
export default function Button1(props) {
    debugger;
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 800 800" style={{enableBackground: 'new 0 0 800 800'}} xmlSpace="preserve" width={800} height={800} {...props}>
      <g id="Shadows">
        <rect id="Gap_Fill" x={320} y="303.5" transform="matrix(0.7908 0.6121 -0.6121 0.7908 328.4933 -161.1477)" style={{stroke: '#000000', strokeMiterlimit: 10}} width={160} height={193} />
        <circle id="Button_4_Shadow" style={{stroke: '#000000', strokeMiterlimit: 10}} cx={575} cy={550} r={195} />
        <circle id="Button_3_Shadow" style={{stroke: '#000000', strokeMiterlimit: 10}} cx={225} cy={600} r={195} />
        <circle id="Button_2_Shadow" style={{stroke: '#000000', strokeMiterlimit: 10}} cx={575} cy={200} r={195} />
        <circle id="Button_1_Shadow" style={{stroke: '#000000', strokeMiterlimit: 10}} cx={225} cy={250} r={195} />
      </g>
      {props.buttonStyle === 'PS' && (
        <g id="PS4">
            <circle id="Button_4_PS4" style={{display: 'none', fill: '#F5837F', stroke: '#000000', strokeMiterlimit: 10}} cx={575} cy={550} r={150} />
            <circle id="Button_3_PS4" style={{display: 'none', fill: '#A5B8D9', stroke: '#000000', strokeMiterlimit: 10}} cx={225} cy={600} r={150} />
            <circle id="Button_2_PS4" style={{display: 'none', fill: '#61C9C3', stroke: '#000000', strokeMiterlimit: 10}} cx={575} cy={200} r={150} />
            <circle id="Button_1_PS4" style={{fill: '#E6A9CD', stroke: '#000000', strokeMiterlimit: 10}} cx={225} cy={250} r={150} />
        </g>
      )}
      {props.buttonStyle === 'XB' && (
          <g id="XBOX" style={{display: 'none'}}>
          <circle id="Button_4" style={{display: 'inline', fill: '#D04242', stroke: '#000000', strokeMiterlimit: 10}} cx={575} cy={550} r={150} />
          <circle id="Button_3" style={{display: 'inline', fill: '#3CFF4E', stroke: '#000000', strokeMiterlimit: 10}} cx={225} cy={600} r={150} />
          <circle id="Button_2" style={{display: 'inline', fill: '#ECDB33', stroke: '#000000', strokeMiterlimit: 10}} cx={575} cy={200} r={150} />
          <circle id="Button_1" style={{display: 'inline', fill: '#40CCD0', stroke: '#000000', strokeMiterlimit: 10}} cx={225} cy={250} r={150} />
        </g>
      )}
      {props.buttonStyle === 'ARCADE' && (
          <g id="STEAM">
          <circle id="Button_4_OFF_1_" style={{display: 'none', fill: '#126B7F', stroke: '#000000', strokeMiterlimit: 10}} cx={575} cy={550} r={150} />
          <circle id="Button_3_OFF_1_" style={{display: 'none', fill: '#126B7F', stroke: '#000000', strokeMiterlimit: 10}} cx={225} cy={600} r={150} />
          <circle id="Button_2_OFF_1_" style={{display: 'none', fill: '#126B7F', stroke: '#000000', strokeMiterlimit: 10}} cx={575} cy={200} r={150} />
          <circle id="Button_1_OFF_1_" style={{fill: '#126B7F', stroke: '#000000', strokeMiterlimit: 10}} cx={225} cy={250} r={150} />
        </g>
      )}
      <g id="OFF">
        <circle id="Button_4_OFF" style={{fill: '#3F5554', stroke: '#000000', strokeMiterlimit: 10}} cx={575} cy={550} r={150} />
        <circle id="Button_3_OFF" style={{fill: '#3F5554', stroke: '#000000', strokeMiterlimit: 10}} cx={225} cy={600} r={150} />
        <circle id="Button_2_OFF" style={{fill: '#3F5554', stroke: '#000000', strokeMiterlimit: 10}} cx={575} cy={200} r={150} />
        <circle id="Button_1_OFF" style={{display: 'none', fill: '#3F5554', stroke: '#000000', strokeMiterlimit: 10}} cx={225} cy={250} r={150} />
      </g>
